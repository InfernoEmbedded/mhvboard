...
/* Example configuration: Port D bit 4 is connected to a jumper which ties
...
#define TIMEOUT_EEPROM_ADDRESS	((const uint8_t *)1023)
static uint8_t timeout;
static uint8_t ticks;
#define TIMEOUT_DISABLED	(255)
#define TIMERVAL TCNT2
...
static inline void  bootLoaderInit(void)
{
	...
	timeout = eeprom_read_byte(TIMEOUT_EEPROM_ADDRESS);

/* Set up Timer2 to tick once every second */
